...
def test_get_parent_partitions_for_partition_range_same_partitioning():
    ...
    result = TimeWindowPartitionMapping().get_parent_partitions_for_partition_range(
...
def test_get_parent_partitions_for_partition_range_same_partitioning_different_formats():
    child_partitions_def = DailyPartitionsDefinition(start_date="2021-05-05")
...
def test_get_parent_partitions_for_partition_range_hourly_child_daily_parent():
...
def test_get_parent_partitions_for_partition_range_daily_child_hourly_parent():
    child_partitions_def = DailyPartitionsDefinition(start_date="2021-05-05")
...
def test_get_parent_partitions_for_partition_range_monthly_child_daily_parent():
